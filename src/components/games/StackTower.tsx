      ...
      <div className="relative mx-auto" style={{ maxWidth: `${W}px` }}>
        ...
        {phase !== "playing" && (
          ...
          >
            ...
            <button className="rounded-full bg-primary px-8 py-2.5 font-bold text-primary-foreground transition-opacity hover:opacity-90">
