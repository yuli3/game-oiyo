...
export const GAME_GUIDES: Record<string, GameGuide> = {
  "shadow-architect": {
    origin:{ko:"그림자 건축가는 입체 구조와 평면 투영의 차이를 놀이로 만든 OIYO 오리지널 3D 공간 퍼즐입니다. 정답 실루엣은 하나지만 깊이가 다른 여러 구조가 답이 될 수 있습니다.",en:"Shadow Architect is an original OIYO 3D spatial puzzle about the difference between a solid structure and its flat projection. One silhouette can have multiple valid structures at different depths.",ja:"影の建築家は、立体構造と平面投影の違いを遊びにしたOIYOオリジナル3D空間パズルです。一つの影に対し、奥行きの異なる複数の構造が正解になります。",zh:"影子建筑师是 OIYO 原创3D空间谜题，以立体结构与平面投影的差异为玩法。同一个剪影可以对应多个深度不同的正确结构。",fr:"Architecte des ombres est un puzzle spatial 3D original d'OIYO sur l'écart entre une structure solide et sa projection plane. Une silhouette accepte plusieurs structures de profondeurs différentes.",es:"Arquitecto de sombras es un puzle espacial 3D original de OIYO sobre la diferencia entre una estructura sólida y su proyección plana. Una silueta admite varias estructuras con distinta profundidad."},
    how:{ko:"다섯 블록 중 하나를 고르고 좌우·상하·앞뒤 이동과 90도 회전을 사용하세요. 금빛 목표 격자와 초록 현재 그림자가 정확히 겹치면 완성됩니다. 카메라를 돌려 가려진 적층을 확인할 수 있습니다.",en:"Choose one of five blocks and move it left, right, up, down, forward or back, or rotate it by 90 degrees. You finish when the green current shadow exactly covers the gold target grid. Orbit the camera to inspect hidden depth.",ja:"5つのブロックから一つを選び、左右・上下・前後移動と90度回転を使います。緑の現在影が金色の目標格子と完全に重なれば完成です。カメラを回して隠れた奥行きを確認できます。",zh:"选择五个方块之一，左右、上下、前后移动或旋转90度。绿色当前影子与金色目标网格完全重合即可完成。旋转镜头可查看被遮挡的深度。",fr:"Choisissez l'un des cinq blocs, déplacez-le dans les six directions ou tournez-le de 90°. La construction est terminée quand l'ombre verte recouvre exactement la grille dorée. Tournez la caméra pour examiner la profondeur cachée.",es:"Elige uno de cinco bloques, muévelo en seis direcciones o gíralo 90°. Terminas cuando la sombra verde cubre exactamente la cuadrícula dorada. Orbita la cámara para revisar la profundidad oculta."},
    faqs:[{q:{ko:"왜 앞뒤로 옮겨도 그림자가 같을 수 있나요?",en:"Why can moving forward or back leave the same shadow?",ja:"前後に動かしても影が同じなのはなぜ？",zh:"为什么前后移动后影子可能不变？",fr:"Pourquoi un déplacement en profondeur peut-il laisser la même ombre ?",es:"¿Por qué mover una pieza en profundidad puede dejar la misma sombra?"},a:{ko:"빛이 블록의 깊이축과 나란히 벽을 향하기 때문입니다. 서로 다른 깊이의 복셀도 벽에서는 같은 칸을 가릴 수 있으며, 이것이 여러 3D 해답을 허용합니다.",en:"The light points toward the wall along the blocks' depth axis. Voxels at different depths can cover the same wall cell, which permits multiple 3D solutions.",ja:"光がブロックの奥行き軸に沿って壁へ向かうためです。異なる奥行きのボクセルが壁の同じマスを覆い、複数の3D解が成立します。",zh:"因为光线沿方块深度轴射向墙面。不同深度的体素可以遮住墙上的同一格，因此会有多个3D解。",fr:"La lumière vise le mur selon l'axe de profondeur. Des voxels situés à des profondeurs différentes peuvent couvrir la même case murale, d'où plusieurs solutions 3D.",es:"La luz apunta al muro siguiendo el eje de profundidad. Vóxeles a distintas profundidades pueden cubrir la misma celda, lo que permite varias soluciones 3D."}}],
  },
  "gravity-garden": {
    origin:{ko:"중력 정원은 식물이 주변 물리장을 바꾼다는 발상으로 만든 OIYO 오리지널 생태 퍼즐입니다. 외부 게임의 캐릭터·미술·레벨을 복제하지 않습니다.",en:"Gravity Garden is an original OIYO ecology puzzle built around plants that alter nearby physics fields. It copies no character, art or level from another game.",ja:"重力の庭は、植物が周囲の物理場を変える発想から生まれたOIYOオリジナル生態パズルです。外部ゲームのキャラクター・美術・レベルは複製していません。",zh:"重力花园是 OIYO 原创生态谜题，核心设定是植物会改变附近的物理场。不复制其他游戏的角色、美术或关卡。",fr:"Jardin gravitationnel est un puzzle écologique original d'OIYO fondé sur des plantes qui modifient les champs physiques voisins. Il ne copie aucun personnage, décor ou niveau externe.",es:"Jardín gravitatorio es un puzle ecológico original de OIYO basado en plantas que alteran los campos físicos cercanos. No copia personajes, arte ni niveles externos."},
    how:{ko:"중력꽃은 물방울을 끌고, 바람갈대는 오른쪽 위로 밀며, 이끼는 속도를 줄입니다. 흐름을 시작하기 전에 최대 6개를 배치해 12초 안에 물방울 5개를 오른쪽 웅덩이로 보내세요.",en:"Gravity blooms pull droplets, wind reeds push them up and right, and moss slows them. Place up to six before starting, then route all five droplets into the right pool within twelve seconds.",ja:"重力花は水滴を引き、風の葦は右上へ押し、苔は減速させます。開始前に最大6個を配置し、12秒以内に5つの水滴を右の池へ導きます。",zh:"重力花吸引水滴，风芦把水滴推向右上方，苔藓使其减速。开始前最多布置六株，在12秒内把五滴水送入右侧水池。",fr:"Les fleurs-gravité attirent, les roseaux poussent vers le haut à droite et la mousse ralentit. Placez jusqu'à six graines avant le départ, puis guidez cinq gouttes au bassin en douze secondes.",es:"Las flores gravitatorias atraen, los juncos empujan arriba y a la derecha y el musgo frena. Coloca hasta seis semillas antes de empezar y guía cinco gotas al estanque en doce segundos."},
    faqs:[{q:{ko:"같은 배치는 매번 같은 결과를 내나요?",en:"Does the same layout always give the same result?",ja:"同じ配置は毎回同じ結果になりますか？",zh:"相同布局每次结果都一样吗？",fr:"Une même disposition donne-t-elle toujours le même résultat ?",es:"¿La misma disposición produce siempre el mismo resultado?"},a:{ko:"네. 엔진은 고정 시간 간격으로 계산되며 같은 씨앗 종류와 좌표는 같은 물방울 경로를 만듭니다. 최고 점수만 이 브라우저에 저장됩니다.",en:"Yes. The engine advances at a fixed time step, so identical seed types and coordinates produce identical droplet paths. Only the best score is stored in this browser.",ja:"はい。エンジンは固定時間刻みで計算するため、同じ種と座標は同じ水滴経路になります。最高点だけがこのブラウザに保存されます。",zh:"是的。引擎按固定时间步计算，因此相同种类与坐标会产生相同水滴路线。只有最高分保存在本浏览器。",fr:"Oui. Le moteur avance à pas de temps fixe : mêmes graines et coordonnées, mêmes trajectoires. Seul le meilleur score reste dans ce navigateur.",es:"Sí. El motor avanza con un paso temporal fijo: las mismas semillas y coordenadas generan las mismas trayectorias. Solo se guarda la mejor puntuación en este navegador."}}],
  },
  "rivals-mind": {
    origin:{ko:"라이벌의 마음은 플레이어의 반복 행동을 이번 경기 안에서만 분류하고, 다음 수의 이유를 공개하는 OIYO 오리지널 결투 게임입니다.",en:"The Rival's Mind is an original OIYO duel that classifies repeated actions only within the current match and discloses why it chose its next move.",ja:"ライバルの心は、今回の試合内だけで反復行動を分類し、次の手の理由を公開するOIYOオリジナル決闘ゲームです。",zh:"对手的心是 OIYO 原创决斗游戏，只在当前比赛中分类重复动作，并公开下一步选择的理由。",fr:"Dans la tête du rival est un duel original d'OIYO qui classe les répétitions uniquement pendant la partie et révèle la raison de son prochain choix.",es:"La mente del rival es un duelo original de OIYO que clasifica repeticiones solo durante la partida y revela el motivo de su siguiente acción."},
    how:{ko:"베기·받아치기·좌우 회피 중 하나를 고르세요. 처음 두 라운드는 라이벌이 탐색하고, 이후에는 가장 자주 쓴 행동을 예측해 대응합니다. 같은 행동을 반복하는 척하다가 패턴을 깨는 것이 핵심입니다.",en:"Choose strike, parry, or an evade direction. The rival samples the first two rounds, then counters your most frequent action. Establish a habit, then break it at the right moment.",ja:"斬る・受け流す・左右回避から選択。最初の2ラウンドは探索し、その後は最頻行動を予測して対処します。癖を見せてから崩すのが要点です。",zh:"从斩击、招架和左右闪避中选择。前两回合对手会试探，之后针对你最常用的动作。先制造习惯，再在关键时刻打破它。",fr:"Choisissez frappe, parade ou direction d'esquive. Le rival observe deux manches puis contre votre action la plus fréquente. Installez une habitude avant de la briser.",es:"Elige ataque, parada o dirección de evasión. El rival tantea dos rondas y luego contrarresta tu acción más frecuente. Crea un hábito y rómpelo en el momento justo."},
    faqs:[{q:{ko:"이 게임이 내 행동을 서버에 보내나요?",en:"Does the game send my behavior to a server?",ja:"行動はサーバーへ送られますか？",zh:"游戏会把我的行为发送到服务器吗？",fr:"Le jeu envoie-t-il mon comportement à un serveur ?",es:"¿El juego envía mi conducta a un servidor?"},a:{ko:"아니요. 적응 판정은 현재 5라운드의 네 가지 행동 횟수만 브라우저 메모리에서 계산하며 경기 종료 후 사라집니다.",en:"No. Adaptation counts only the four action types from the current five-round match in browser memory, and that match history disappears afterward.",ja:"いいえ。適応判定は今回5ラウンドの4行動の回数だけをブラウザメモリで計算し、試合後に消えます。",zh:"不会。适应判断只在浏览器内存中统计本场五回合的四类动作，比赛结束后即消失。",fr:"Non. L'adaptation compte seulement les quatre actions des cinq manches en mémoire du navigateur, puis cet historique disparaît.",es:"No. La adaptación solo cuenta las cuatro acciones de las cinco rondas en la memoria del navegador y el historial desaparece al terminar."}}],
  },
  "memory-palace-thieves": {
    origin: {
      ko: "기억 궁전 도둑들은 관찰 단계와 행동 단계의 정보 차이를 잠입 규칙으로 만든 OIYO 오리지널 3D 게임입니다. 매일 같은 날짜는 같은 경비 순찰을 만듭니다.",
      en: "Memory Palace Thieves is an original OIYO 3D game that turns the information gap between observation and action into a stealth rule. The same date always produces the same patrol.",
      ja: "記憶宮殿の盗賊は、観察と行動の情報差を潜入ルールにしたOIYOオリジナル3Dゲームです。同じ日付には同じ巡回が生成されます。",
      zh: "记忆宫殿盗贼是 OIYO 原创3D游戏，把观察阶段与行动阶段的信息差变成潜行规则。同一日期总会生成相同巡逻路线。",
      fr: "Voleurs du palais mental est un jeu 3D original d'OIYO qui transforme l'écart d'information entre observation et action en règle d'infiltration. Une même date produit la même ronde.",
      es: "Ladrones del palacio mental es un juego 3D original de OIYO que convierte la diferencia entre observar y actuar en una regla de sigilo. La misma fecha produce la misma patrulla.",
    },
    how: {
      ko: "불이 켜진 동안 경비의 12턴 순찰을 기억하세요. 소등 후 한 칸씩 이동해 오른쪽 아래 유물을 확보하고 왼쪽 아래 출구로 돌아오되, 경비와 같은 칸이나 막힘 없는 직선 시야에 들어가면 발각됩니다.",
      en: "Memorize the guard's twelve-turn patrol while the lights are on. After blackout, move one tile at a time to collect the lower-right artifact and return to the lower-left exit without sharing a tile or clear sightline with the guard.",
      ja: "照明中に警備員の12ターン巡回を記憶します。消灯後は1マスずつ進み、右下の秘宝を取り左下の出口へ戻ります。同じマスや遮蔽物のない直線視野に入ると発見されます。",
      zh: "亮灯时记住警卫的12回合巡逻。熄灯后每次移动一格，取得右下藏品并返回左下出口；若与警卫同格或进入无遮挡直线视野，就会被发现。",
      fr: "Mémorisez les douze tours de ronde sous la lumière. Dans le noir, avancez case par case, prenez l'œuvre en bas à droite et revenez à la sortie en bas à gauche sans partager une case ni une ligne de vue dégagée avec le garde.",
      es: "Memoriza los doce turnos de patrulla con las luces encendidas. A oscuras, avanza casilla a casilla, recoge la pieza abajo a la derecha y vuelve a la salida izquierda sin compartir casilla ni línea de visión con el guardia.",
    },
    faqs: [{
      q:{ko:"기억 섬광은 무엇인가요?",en:"What is a memory flash?",ja:"記憶の閃光とは？",zh:"什么是记忆闪光？",fr:"Qu'est-ce qu'un éclair de mémoire ?",es:"¿Qué es un destello de memoria?"},
      a:{ko:"한 판에 두 번, 0.9초 동안 미술관과 경비 위치를 다시 볼 수 있습니다. 턴은 진행되지 않으므로 막다른 추측을 줄이는 접근성 보조 수단입니다.",en:"Twice per run, it reveals the museum and guard for 0.9 seconds without advancing the turn. It is an accessibility aid that reduces blind guessing.",ja:"1回につき2度、ターンを進めず0.9秒だけ館内と警備位置を再表示します。闇雲な推測を減らす支援機能です。",zh:"每局可使用两次，在不推进回合的情况下显示美术馆与警卫0.9秒，用于减少盲猜。",fr:"Deux fois par partie, il révèle le musée et le garde pendant 0,9 seconde sans avancer le tour. C'est une aide qui limite les choix aveugles.",es:"Dos veces por partida, muestra el museo y al guardia durante 0,9 segundos sin avanzar el turno. Es una ayuda para reducir decisiones a ciegas."}
    }],
  },
  "time-loop-rescue": {
    origin: {
  ...
  "hitori": {
    ...
    faqs: [
      { q: { ko: "추측 없이 논리만으로 풀 수 있나요?", en: "Can every puzzle be solved by logic alone?", ja: "推測なしで論理だけで解けますか？", zh: "每道题都能纯逻辑解开吗？", fr: "Chaque grille se résout-elle par la seule logique ?", es: "¿Toda partida se resuelve solo con lógica?" }, a: { ko: "네. 모든 판은 유일한 해가 있으며, '이 칸이 검으면 규칙 위반' 같은 연쇄로 찍지 않고 풀 수 있습니다.", en: "Yes. Every board has a unique solution, reachable by chains like 'shading this cell would break a rule' without guessing.", ja: "はい。すべての盤に唯一の解があり、「このマスを黒くすると規則違反」といった連鎖で当て推量なしに解けます。", zh: "可以。每个盘面都有唯一解，靠「涂黑这格就会违规」这类推理链即可不猜解出。", fr: "Oui. Chaque grille a une solution unique, atteignable par des chaînes du type « noircir cette case enfreindrait une règle », sans deviner.", es: "Sí. Cada tablero tiene solución única, alcanzable con cadenas como «sombrear esta casilla rompería una regla», sin adivinar." } },
      { q: { ko: "진행 상황이 저장되나요?", en: "Is my progress saved?", ja: "進行状況は保存されますか？", zh: "进度会保存吗？", fr: "Ma progression est-elle sauvegardée ?", es: "¿Se guarda mi progreso?" }, a: { ko: "현재 판과 기록은 이 브라우저의 localStorage에만 저장됩니다. 계정도, 서버 저장도 없습니다.", en: "The current board and your records are stored only in this browser's localStorage. There is no account or server save.", ja: "現在の盤と記録はこのブラウザのlocalStorageにのみ保存されます。アカウントもサーバー保存もありません。", zh: "当前盘面和记录只保存在本浏览器的localStorage中。没有账号，也没有服务器存档。", fr: "La grille en cours et vos records ne sont conservés que dans le localStorage de ce navigateur. Aucun compte ni sauvegarde serveur.", es: "El tablero actual y tus récords se guardan solo en el localStorage de este navegador. No hay cuenta ni guardado en servidor." } },
    ],
  },
  "janggi": {
  ...
  "light-up": {
    ...
    faqs: [
      { q: { ko: "전구를 어디부터 놓아야 하나요?", en: "Where should I place the first bulbs?", ja: "最初の電球はどこに置く？", zh: "第一批灯泡放哪里？", fr: "Où placer les premières ampoules ?", es: "¿Dónde pongo las primeras bombillas?" }, a: { ko: "0이 적힌 벽 주변과, 다른 칸에서 절대 비출 수 없는 흰 칸부터 확정하세요. 숫자 벽의 남은 빈칸 수와 필요한 전구 수가 같으면 그 칸은 모두 전구입니다.", en: "Start around walls marked 0 and white cells no other cell can ever light. When a numbered wall's remaining free cells equal the bulbs it still needs, all of them are bulbs.", ja: "0の壁の周りと、他のどのマスからも照らせない白マスから確定します。数字の壁の残り空きマス数と必要電球数が等しければ、それらはすべて電球です。", zh: "从标0的墙周围和任何其他格都照不到的白格入手。数字墙的剩余空格数正好等于还需灯泡数时，那些格全是灯泡。", fr: "Commencez autour des murs marqués 0 et des cases qu'aucune autre ne peut éclairer. Si les cases libres restantes d'un mur numéroté égalent les ampoules manquantes, ce sont toutes des ampoules.", es: "Empieza junto a los muros marcados con 0 y las casillas que ninguna otra puede iluminar. Si las casillas libres que quedan de un muro numerado igualan las bombillas que faltan, todas son bombillas." } },
      { q: { ko: "기록은 어디에 저장되나요?", en: "Where are my records kept?", ja: "記録はどこに保存されますか？", zh: "记录保存在哪里？", fr: "Où sont conservés mes records ?", es: "¿Dónde se guardan mis récords?" }, a: { ko: "풀이 시간과 진행 상황은 이 브라우저의 localStorage에만 저장됩니다. 계정도 서버 저장도 없습니다.", en: "Solve times and progress are stored only in this browser's localStorage. There is no account or server save.", ja: "クリア時間と進行状況はこのブラウザのlocalStorageにのみ保存されます。アカウントもサーバー保存もありません。", zh: "解题时间和进度只保存在本浏览器的localStorage中。没有账号，也没有服务器存档。", fr: "Les temps et la progression ne sont conservés que dans le localStorage de ce navigateur. Aucun compte ni sauvegarde serveur.", es: "Los tiempos y el progreso se guardan solo en el localStorage de este navegador. No hay cuenta ni guardado en servidor." } },
    ],
  },
  "lotto-generator": {
  ...
  "memory-card-game": {
    ...
    faqs: [
      { q: { ko: "카드 배치는 매번 바뀌나요?", en: "Is the layout shuffled every game?", ja: "カード配置は毎回変わりますか？", zh: "每局的牌面布局都会重新洗吗？", fr: "La disposition est-elle mélangée à chaque partie ?", es: "¿El reparto se baraja cada partida?" }, a: { ko: "네. 새 게임마다 카드 쌍이 무작위로 다시 배치되므로 위치를 외워 재사용할 수 없습니다.", en: "Yes. Every new game reshuffles the pairs, so you cannot reuse memorized positions.", ja: "はい。新しいゲームごとにペアが再配置されるため、覚えた位置を使い回すことはできません。", zh: "会。每开新局都会重新打乱配对，记住的位置无法沿用。", fr: "Oui. Chaque nouvelle partie remélange les paires : impossible de réutiliser des positions mémorisées.", es: "Sí. Cada partida nueva vuelve a barajar las parejas, así que no puedes reutilizar posiciones memorizadas." } },
      { q: { ko: "시도 횟수가 기록되나요?", en: "Are my attempts recorded?", ja: "試行回数は記録されますか？", zh: "尝试次数会被记录吗？", fr: "Mes essais sont-ils enregistrés ?", es: "¿Se registran mis intentos?" }, a: { ko: "최소 시도·최단 시간 기록이 이 브라우저의 localStorage에만 남습니다. 계정이나 서버 저장은 없습니다.", en: "Your fewest-moves and best-time records stay only in this browser's localStorage. There is no account or server save.", ja: "最少手数・最短時間の記録はこのブラウザのlocalStorageにのみ残ります。アカウントやサーバー保存はありません。", zh: "最少步数和最短用时的记录只留在本浏览器的localStorage中。没有账号或服务器存档。", fr: "Vos records de coups et de temps restent uniquement dans le localStorage de ce navigateur. Aucun compte ni sauvegarde serveur.", es: "Tus récords de menos movimientos y mejor tiempo quedan solo en el localStorage de este navegador. No hay cuenta ni guardado en servidor." } },
    ],
  },
  "number-guessing": {
    ...
    faqs: [
      { q: { ko: "가장 빠르게 맞히는 방법은?", en: "What is the fastest strategy?", ja: "最速で当てる方法は？", zh: "最快的猜法是什么？", fr: "Quelle est la stratégie la plus rapide ?", es: "¿Cuál es la estrategia más rápida?" }, a: { ko: "매번 남은 범위의 중간값을 부르는 이분 탐색입니다. 1~100이면 최악의 경우에도 7번 안에 맞힙니다.", en: "Binary search: always guess the midpoint of the remaining range. For 1–100 that solves it in at most 7 guesses.", ja: "毎回、残り範囲の中央値を言う二分探索です。1〜100なら最悪でも7回で当たります。", zh: "二分查找：每次都猜剩余区间的中点。1到100时最多7次就能猜中。", fr: "Recherche binaire : proposez toujours le milieu de l'intervalle restant. Pour 1–100, sept essais au maximum.", es: "Búsqueda binaria: propón siempre el punto medio del rango restante. Para 1–100 se resuelve en 7 intentos como máximo." } },
      { q: { ko: "숫자는 정말 무작위인가요?", en: "Is the target really random?", ja: "数字は本当にランダムですか？", zh: "目标数字真的是随机的吗？", fr: "Le nombre est-il vraiment aléatoire ?", es: "¿El número es realmente aleatorio?" }, a: { ko: "네. 게임 시작 시 브라우저에서 무작위로 정하며, 서버로 전송하거나 저장하지 않습니다. 계정도 없습니다.", en: "Yes. It is chosen at random in your browser when the game starts, never sent to or stored on a server. There is no account.", ja: "はい。ゲーム開始時にブラウザ内で無作為に決まり、サーバーへ送信も保存もしません。アカウントもありません。", zh: "是。开局时在你的浏览器里随机选定，不会发送到服务器也不会存储。没有账号。", fr: "Oui. Il est tiré au hasard dans votre navigateur au début, jamais envoyé ni stocké sur un serveur. Aucun compte.", es: "Sí. Se elige al azar en tu navegador al empezar, nunca se envía ni se guarda en un servidor. No hay cuenta." } },
    ],
  },
  "snake-game": {
    ...
    faqs: [
      { q: { ko: "속도가 점점 빨라지나요?", en: "Does the snake speed up?", ja: "スピードは上がりますか？", zh: "蛇会越来越快吗？", fr: "Le serpent accélère-t-il ?", es: "¿La serpiente acelera?" }, a: { ko: "네. 먹이를 먹을수록 이동 간격이 짧아져 조작 여유가 줄어듭니다. 벽과 자기 몸이 유일한 위험 요소입니다.", en: "Yes. Each pellet shortens the step interval, leaving less reaction time. Walls and your own body are the only hazards.", ja: "はい。エサを食べるほど移動間隔が短くなり、反応の余裕が減ります。危険は壁と自分の体だけです。", zh: "会。每吃一颗豆，移动间隔就变短，反应余地更小。唯一的危险是墙和自己的身体。", fr: "Oui. Chaque pastille raccourcit l'intervalle de déplacement, réduisant le temps de réaction. Seuls les murs et votre corps sont dangereux.", es: "Sí. Cada bolita acorta el intervalo de avance y deja menos tiempo de reacción. Los únicos peligros son los muros y tu propio cuerpo." } },
      { q: { ko: "최고 점수는 저장되나요?", en: "Is my high score saved?", ja: "ハイスコアは保存されますか？", zh: "最高分会保存吗？", fr: "Mon meilleur score est-il sauvegardé ?", es: "¿Se guarda mi puntuación máxima?" }, a: { ko: "최고 점수는 이 브라우저의 localStorage에만 저장됩니다. 계정도 온라인 순위표도 없습니다.", en: "Your high score is stored only in this browser's localStorage. There is no account or online leaderboard.", ja: "ハイスコアはこのブラウザのlocalStorageにのみ保存されます。アカウントもオンラインランキングもありません。", zh: "最高分只保存在本浏览器的localStorage中。没有账号，也没有在线排行榜。", fr: "Votre meilleur score est conservé uniquement dans le localStorage de ce navigateur. Aucun compte ni classement en ligne.", es: "Tu puntuación máxima se guarda solo en el localStorage de este navegador. No hay cuenta ni clasificación en línea." } },
    ],
  },
  "tents-and-trees": {
  ...
  "balance-game": {
    ...
    faqs: [
      { q: { ko: "정답이 있나요?", en: "Is there a right answer?", ja: "正解はありますか？", zh: "有标准答案吗？", fr: "Y a-t-il une bonne réponse ?", es: "¿Hay una respuesta correcta?" }, a: { ko: "없습니다. 68문항 모두 취향을 묻는 양자택일이며, 끝나면 각 선택에서 내가 다수파였는지 소수파였는지 비율만 보여 줍니다.", en: "No. All 68 items are taste-based either/or questions; at the end it only shows whether your pick was the majority or minority choice.", ja: "ありません。68問すべて好みを問う二択で、最後に各選択で自分が多数派か少数派かの割合だけを表示します。", zh: "没有。全部68题都是关于喜好的二选一，结束后只显示你的每个选择属于多数派还是少数派。", fr: "Non. Les 68 questions sont des choix binaires de goût ; à la fin, on voit seulement si votre choix était majoritaire ou minoritaire.", es: "No. Las 68 preguntas son dilemas de gustos; al final solo muestra si tu elección fue mayoritaria o minoritaria." } },
      { q: { ko: "내 답이 다른 사람에게 전송되나요?", en: "Are my answers sent anywhere?", ja: "回答はどこかに送信されますか？", zh: "我的答案会被发送出去吗？", fr: "Mes réponses sont-elles envoyées quelque part ?", es: "¿Mis respuestas se envían a algún sitio?" }, a: { ko: "아니요. 선택은 브라우저 안에서만 집계되어 비율을 계산하며 서버로 전송하거나 저장하지 않습니다. 계정도 없습니다.", en: "No. Choices are tallied only in your browser to compute the ratio; nothing is sent to or stored on a server. There is no account.", ja: "いいえ。選択はブラウザ内だけで集計して割合を出し、サーバーへ送信も保存もしません。アカウントもありません。", zh: "不会。选择只在你的浏览器里统计以算出比例，不发送到服务器也不存储。没有账号。", fr: "Non. Les choix ne sont comptés que dans votre navigateur pour le ratio ; rien n'est envoyé ni stocké sur un serveur. Aucun compte.", es: "No. Las elecciones se cuentan solo en tu navegador para calcular la proporción; nada se envía ni se guarda en un servidor. No hay cuenta." } },
    ],
  },
  "wheel-spinner": {
    ...
    faqs: [
      { q: { ko: "돌림판 결과는 정말 무작위인가요?", en: "Is the spin result truly random?", ja: "回転結果は本当にランダムですか？", zh: "转盘结果真的是随机的吗？", fr: "Le résultat du tirage est-il vraiment aléatoire ?", es: "¿El giro es realmente aleatorio?" }, a: { ko: "네. 각 항목은 동일한 확률을 가지며 브라우저의 난수로 결정됩니다. 항목을 여러 번 입력하면 그만큼 가중치가 커집니다.", en: "Yes. Every entry has an equal chance, decided by the browser's random generator. Adding an entry more than once weights it proportionally.", ja: "はい。各項目は等確率で、ブラウザの乱数で決まります。同じ項目を複数回入れるとその分だけ重みが増します。", zh: "是。每个条目概率相等，由浏览器的随机数决定。同一条目输入多次，权重就按次数增加。", fr: "Oui. Chaque entrée a une chance égale, décidée par le générateur aléatoire du navigateur. Répéter une entrée augmente son poids d'autant.", es: "Sí. Cada entrada tiene la misma probabilidad, decidida por el generador aleatorio del navegador. Repetir una entrada aumenta su peso en proporción." } },
      { q: { ko: "입력한 항목이 저장되나요?", en: "Are my entries saved?", ja: "入力した項目は保存されますか？", zh: "输入的条目会保存吗？", fr: "Mes entrées sont-elles sauvegardées ?", es: "¿Se guardan las opciones que escribo?" }, a: { ko: "마지막 목록은 편의를 위해 이 브라우저에만 남고 서버로 전송되지 않습니다. 계정은 없습니다.", en: "Your last list is kept only in this browser for convenience and is never sent to a server. There is no account.", ja: "直近のリストは利便性のためこのブラウザにのみ残り、サーバーへ送信されません。アカウントはありません。", zh: "上次的列表为方便起见只留在本浏览器，不会发送到服务器。没有账号。", fr: "Votre dernière liste n'est gardée que dans ce navigateur, pour le confort, et n'est jamais envoyée à un serveur. Aucun compte.", es: "Tu última lista se guarda solo en este navegador por comodidad y nunca se envía a un servidor. No hay cuenta." } },
    ],
  },
  "blackjack": {
  ...
  "dice-roller": {
    ...
    faqs: [
      { q: { ko: "어떤 주사위를 굴릴 수 있나요?", en: "Which dice can I roll?", ja: "どんなダイスを振れますか？", zh: "可以掷哪些骰子？", fr: "Quels dés puis-je lancer ?", es: "¿Qué dados puedo lanzar?" }, a: { ko: "면 수(d4·d6·d8·d10·d12·d20 등)와 개수를 골라 한 번에 굴릴 수 있어 보드게임과 TRPG에 그대로 쓸 수 있습니다.", en: "Choose the number of faces (d4, d6, d8, d10, d12, d20…) and how many to roll at once — ready for board games and tabletop RPGs.", ja: "面数(d4・d6・d8・d10・d12・d20など)と個数を選んで一度に振れ、ボードゲームやTRPGにそのまま使えます。", zh: "可选择面数（d4、d6、d8、d10、d12、d20等）和数量一次投掷，直接用于桌游和跑团。", fr: "Choisissez le nombre de faces (d4, d6, d8, d10, d12, d20…) et combien lancer d'un coup — prêt pour jeux de plateau et JDR.", es: "Elige el número de caras (d4, d6, d8, d10, d12, d20…) y cuántos lanzar a la vez: listo para juegos de mesa y rol." } },
      { q: { ko: "결과가 조작되지 않나요?", en: "Are the rolls fair?", ja: "出目は公正ですか？", zh: "点数是公平的吗？", fr: "Les lancers sont-ils équitables ?", es: "¿Las tiradas son justas?" }, a: { ko: "각 면은 동일한 확률이며 브라우저 난수로 결정됩니다. 결과는 저장되지 않고 계정도 없습니다.", en: "Every face has equal probability, decided by the browser's random generator. Results are not stored and there is no account.", ja: "各面は等確率で、ブラウザの乱数で決まります。結果は保存されず、アカウントもありません。", zh: "每一面概率相等，由浏览器随机数决定。结果不会保存，也没有账号。", fr: "Chaque face a la même probabilité, décidée par le générateur aléatoire du navigateur. Les résultats ne sont pas stockés et il n'y a pas de compte.", es: "Cada cara tiene la misma probabilidad, decidida por el generador aleatorio del navegador. Los resultados no se guardan y no hay cuenta." } },
    ],
  },
  "dominoes": {
    ...
    faqs: [
      { q: { ko: "상대는 어떻게 두나요?", en: "How does the opponent play?", ja: "相手はどう打ちますか？", zh: "对手是怎么出牌的？", fr: "Comment joue l'adversaire ?", es: "¿Cómo juega el rival?" }, a: { ko: "컴퓨터 상대는 손패를 빨리 줄이면서 자신이 이어 갈 수 있는 숫자를 판 끝에 남기려 합니다. 낼 패가 없으면 패스합니다.", en: "The computer opponent tries to shed tiles quickly while keeping numbers it can follow on the open ends, and passes when it cannot play.", ja: "コンピュータ相手は手牌を早く減らしつつ、自分が続けられる数字を盤の端に残そうとし、置けなければパスします。", zh: "电脑对手会尽快出牌，同时把自己能接的点数留在开放端，无牌可出时就过。", fr: "L'adversaire informatique tente de se défausser vite tout en gardant sur les bouts ouverts des chiffres qu'il peut suivre, et passe s'il ne peut pas jouer.", es: "El rival de la máquina intenta soltar fichas rápido mientras deja en los extremos abiertos números que puede seguir, y pasa cuando no puede jugar." } },
      { q: { ko: "점수와 승패가 저장되나요?", en: "Is my win-loss record saved?", ja: "勝敗記録は保存されますか？", zh: "胜负记录会保存吗？", fr: "Mon bilan est-il sauvegardé ?", es: "¿Se guarda mi historial de victorias?" }, a: { ko: "승패 기록은 이 브라우저의 localStorage에만 남습니다. 계정도 온라인 대전도 없습니다.", en: "Your win-loss record stays only in this browser's localStorage. There is no account or online multiplayer.", ja: "勝敗記録はこのブラウザのlocalStorageにのみ残ります。アカウントもオンライン対戦もありません。", zh: "胜负记录只留在本浏览器的localStorage中。没有账号，也没有在线对战。", fr: "Votre bilan reste uniquement dans le localStorage de ce navigateur. Aucun compte ni multijoueur en ligne.", es: "Tu historial de victorias y derrotas queda solo en el localStorage de este navegador. No hay cuenta ni multijugador en línea." } },
    ],
  },
  "freecell": {
    ...
    faqs: [
      { q: { ko: "모든 판을 이길 수 있나요?", en: "Is every deal winnable?", ja: "すべての配りは勝てますか？", zh: "每一局都能赢吗？", fr: "Chaque donne est-elle gagnable ?", es: "¿Toda reparto tiene solución?" }, a: { ko: "프리셀은 거의 모든 배치가 해결 가능한 것으로 알려져 있습니다. 막혔다면 대개 순서 문제이니 되돌리기로 다른 경로를 시도하세요.", en: "FreeCell is famous for being solvable in almost every deal. If you get stuck it is usually a move-order problem — undo and try another route.", ja: "フリーセルはほぼすべての配りが解けることで知られます。詰まったら大抵は手順の問題なので、元に戻して別の道を試しましょう。", zh: "自由接龙以几乎每局都可解著称。卡住通常是走法顺序的问题——撤销后换条路线试试。", fr: "Le FreeCell est réputé jouable sur presque toutes les donnes. Si vous bloquez, c'est souvent un problème d'ordre : annulez et essayez une autre voie.", es: "El FreeCell es famoso por tener solución en casi todos los repartos. Si te atascas suele ser cuestión de orden: deshaz y prueba otra ruta." } },
      { q: { ko: "진행 중인 판이 저장되나요?", en: "Is a game in progress saved?", ja: "進行中の局は保存されますか？", zh: "进行中的牌局会保存吗？", fr: "Une partie en cours est-elle sauvegardée ?", es: "¿Se guarda una partida en curso?" }, a: { ko: "현재 판과 승패 기록은 이 브라우저의 localStorage에만 저장됩니다. 계정도 서버 저장도 없습니다.", en: "The current board and your win-loss record are stored only in this browser's localStorage. There is no account or server save.", ja: "現在の局と勝敗記録はこのブラウザのlocalStorageにのみ保存されます。アカウントもサーバー保存もありません。", zh: "当前牌局和胜负记录只保存在本浏览器的localStorage中。没有账号或服务器存档。", fr: "La partie en cours et votre bilan ne sont conservés que dans le localStorage de ce navigateur. Aucun compte ni sauvegarde serveur.", es: "El tablero actual y tu historial se guardan solo en el localStorage de este navegador. No hay cuenta ni guardado en servidor." } },
    ],
  ...
  "dot-pet": {
    ...
    faqs: [
      { q: { ko: "접속하지 않은 동안에도 스탯이 떨어지나요?", en: "Do stats drop while I'm away?", ja: "離れている間もステータスは下がりますか？", zh: "不在线时数值也会下降吗？", fr: "Les stats baissent-elles en mon absence ?", es: "¿Las estadísticas bajan mientras no estoy?" }, a: { ko: "네. 마지막 접속 시각을 기억해 자리를 비운 시간만큼 배고픔·기분이 내려갑니다. 오래 방치하면 성장 속도도 느려집니다.", en: "Yes. It remembers your last visit and lowers hunger and mood for the time you were gone. Long neglect also slows growth.", ja: "はい。最後の訪問時刻を覚えていて、離れていた分だけ空腹と気分が下がります。長く放置すると成長も遅くなります。", zh: "会。它记住你上次来的时间，按离开的时长降低饥饿和心情。长期不管，成长也会变慢。", fr: "Oui. Il retient votre dernière visite et fait baisser faim et humeur selon la durée d'absence. Une longue négligence ralentit aussi la croissance.", es: "Sí. Recuerda tu última visita y baja el hambre y el ánimo según el tiempo ausente. El descuido prolongado también frena el crecimiento." } },
      { q: { ko: "펫 데이터는 어디에 저장되나요?", en: "Where is my pet saved?", ja: "ペットのデータはどこに保存されますか？", zh: "宠物数据保存在哪里？", fr: "Où mon animal est-il sauvegardé ?", es: "¿Dónde se guarda mi mascota?" }, a: { ko: "펫의 상태·나이·경험치는 이 브라우저의 localStorage에만 저장됩니다. 계정도, 서버 동기화도, 실제 화폐도 없습니다.", en: "Your pet's state, age and XP are stored only in this browser's localStorage. There is no account, server sync or real currency.", ja: "ペットの状態・年齢・経験値はこのブラウザのlocalStorageにのみ保存されます。アカウント、サーバー同期、実通貨はありません。", zh: "宠物的状态、年龄和经验只保存在本浏览器的localStorage中。没有账号、服务器同步或真实货币。", fr: "L'état, l'âge et l'XP de votre animal sont conservés uniquement dans le localStorage de ce navigateur. Aucun compte, synchro serveur ni argent réel.", es: "El estado, la edad y la XP de tu mascota se guardan solo en el localStorage de este navegador. No hay cuenta, sincronización ni dinero real." } },
    ],
  },
  "dot-jumpking": {
    ...
    faqs: [
      { q: { ko: "한 번 실수하면 떨어지나요?", en: "Does one mistake drop me?", ja: "一度のミスで落ちますか？", zh: "一次失误就会掉下去吗？", fr: "Une seule erreur me fait chuter ?", es: "¿Un solo error me hace caer?" }, a: { ko: "네. 점프 힘을 잘못 모으면 원작 '점프 킹'처럼 아래 플랫폼으로 떨어져 진행을 잃습니다. 그게 이 장르의 핵심 긴장감입니다.", en: "Yes. Mis-charge a jump and you fall to a lower platform and lose progress, just like the original Jump King — that tension is the point of the genre.", ja: "はい。ジャンプの溜めを誤ると原作『Jump King』のように下の足場へ落ち、進行を失います。その緊張感がこのジャンルの核心です。", zh: "会。蓄力失误就会像原作《Jump King》一样掉到下方平台、丢失进度——这种紧张感正是这个类型的核心。", fr: "Oui. Une charge de saut ratée vous fait tomber sur une plateforme inférieure et perdre votre progression, comme dans Jump King — cette tension est le sel du genre.", es: "Sí. Si cargas mal el salto caes a una plataforma inferior y pierdes progreso, igual que en Jump King: esa tensión es la gracia del género." } },
      { q: { ko: "최고 높이가 저장되나요?", en: "Is my best height saved?", ja: "最高到達点は保存されますか？", zh: "最高高度会保存吗？", fr: "Ma meilleure hauteur est-elle sauvegardée ?", es: "¿Se guarda mi altura máxima?" }, a: { ko: "도달한 최고 높이는 이 브라우저의 localStorage에만 저장됩니다. 계정도 온라인 순위표도 없습니다.", en: "Your best height reached is stored only in this browser's localStorage. There is no account or online leaderboard.", ja: "到達した最高高度はこのブラウザのlocalStorageにのみ保存されます。アカウントもオンラインランキングもありません。", zh: "到达的最高高度只保存在本浏览器的localStorage中。没有账号，也没有在线排行榜。", fr: "Votre meilleure hauteur atteinte est conservée uniquement dans le localStorage de ce navigateur. Aucun compte ni classement en ligne.", es: "Tu mejor altura alcanzada se guarda solo en el localStorage de este navegador. No hay cuenta ni clasificación en línea." } },
    ],
  },
  "block-burst": {
  ...
  "animal-pop": {
    ...
    faqs: [
      { q: { ko: "피버 모드는 어떻게 발동하나요?", en: "How do I trigger Fever mode?", ja: "フィーバーはどう発動しますか？", zh: "如何触发火力全开（Fever）？", fr: "Comment déclencher le mode Fièvre ?", es: "¿Cómo activo el modo Fiebre?" }, a: { ko: "연쇄로 콤보 5를 쌓으면 10초간 점수가 2배가 되는 피버가 시작됩니다. 제한시간 60초 안에 피버를 몇 번 만드느냐가 점수를 가릅니다.", en: "Chain to a 5-combo and Fever starts: 10 seconds of double score. How many Fevers you trigger inside the 60-second limit decides your score.", ja: "連鎖でコンボ5を積むと、10秒間スコア2倍のフィーバーが始まります。60秒の制限時間内にフィーバーを何回作るかでスコアが決まります。", zh: "连锁凑够5连击就进入Fever：10秒内得分翻倍。在60秒限时内触发几次Fever决定你的分数。", fr: "Enchaînez jusqu'à un combo de 5 et la Fièvre démarre : 10 secondes à score doublé. Le nombre de Fièvres déclenchées dans la limite de 60 s fait votre score.", es: "Encadena hasta un combo de 5 y empieza la Fiebre: 10 segundos con puntuación doble. Cuántas Fiebres logres en el límite de 60 s decide tu puntuación." } },
      { q: { ko: "최고 점수가 저장되나요?", en: "Is my high score saved?", ja: "ハイスコアは保存されますか？", zh: "最高分会保存吗？", fr: "Mon meilleur score est-il sauvegardé ?", es: "¿Se guarda mi puntuación máxima?" }, a: { ko: "최고 점수는 이 브라우저의 localStorage에만 저장됩니다. 계정도 온라인 순위표도 없습니다.", en: "Your high score is stored only in this browser's localStorage. There is no account or online leaderboard.", ja: "ハイスコアはこのブラウザのlocalStorageにのみ保存されます。アカウントもオンラインランキングもありません。", zh: "最高分只保存在本浏览器的localStorage中。没有账号，也没有在线排行榜。", fr: "Votre meilleur score est conservé uniquement dans le localStorage de ce navigateur. Aucun compte ni classement en ligne.", es: "Tu puntuación máxima se guarda solo en el localStorage de este navegador. No hay cuenta ni clasificación en línea." } },
    ],
  },
  kurodoko: {
  ...
  "puzzle-15": {
    ...
    faqs: [
      { q: { ko: "모든 시작 배치를 풀 수 있나요?", en: "Is every starting layout solvable?", ja: "すべての初期配置は解けますか？", zh: "每种初始排列都能还原吗？", fr: "Toute disposition de départ est-elle résoluble ?", es: "¿Todo reparto inicial tiene solución?" }, a: { ko: "네. 게임은 항상 풀 수 있는 배치만 섞어서 냅니다. 새뮤얼 로이드가 걸었던 '풀 수 없는 배치'는 나오지 않습니다.", en: "Yes. The game only ever shuffles into solvable configurations. The famously impossible arrangement Sam Loyd offered a prize for never appears.", ja: "はい。ゲームは常に解ける配置だけをシャッフルして出します。サミュエル・ロイドが賞金を懸けた「解けない配置」は出ません。", zh: "可以。游戏只会打乱成有解的排列。萨姆·劳埃德悬赏的那个「无解排列」不会出现。", fr: "Oui. Le jeu ne mélange que vers des configurations résolubles. L'agencement impossible mis à prix par Sam Loyd n'apparaît jamais.", es: "Sí. El juego solo baraja hacia configuraciones resolubles. El famoso arreglo imposible por el que Sam Loyd ofreció premio nunca aparece." } },
      { q: { ko: "이동 수와 시간이 기록되나요?", en: "Are moves and time recorded?", ja: "手数と時間は記録されますか？", zh: "步数和时间会记录吗？", fr: "Les coups et le temps sont-ils enregistrés ?", es: "¿Se registran movimientos y tiempo?" }, a: { ko: "최소 이동 수와 최단 시간이 이 브라우저의 localStorage에만 저장됩니다. 계정도 서버 저장도 없습니다.", en: "Your fewest moves and best time are stored only in this browser's localStorage. There is no account or server save.", ja: "最少手数と最短時間はこのブラウザのlocalStorageにのみ保存されます。アカウントもサーバー保存もありません。", zh: "最少步数和最短用时只保存在本浏览器的localStorage中。没有账号或服务器存档。", fr: "Vos records de coups et de temps ne sont conservés que dans le localStorage de ce navigateur. Aucun compte ni sauvegarde serveur.", es: "Tus récords de movimientos y tiempo se guardan solo en el localStorage de este navegador. No hay cuenta ni guardado en servidor." } },
    ],
  },
  maze: {
    ...
    faqs: [
      { q: { ko: "미로는 매번 다른가요?", en: "Is the maze different each time?", ja: "迷路は毎回違いますか？", zh: "迷宫每次都不一样吗？", fr: "Le labyrinthe change-t-il à chaque fois ?", es: "¿El laberinto cambia cada vez?" }, a: { ko: "네. 재귀적 백트래킹 알고리즘으로 매판 새로 생성되며 언제나 출구까지 이르는 경로가 하나 이상 존재합니다.", en: "Yes. Each maze is generated fresh with recursive backtracking and always has at least one path to the exit.", ja: "はい。再帰的バックトラッキングで毎回新しく生成され、常に出口へ至る経路が一つ以上あります。", zh: "是。每关都用递归回溯算法重新生成，且始终至少有一条通往出口的路径。", fr: "Oui. Chaque labyrinthe est généré par backtracking récursif et comporte toujours au moins un chemin vers la sortie.", es: "Sí. Cada laberinto se genera con backtracking recursivo y siempre tiene al menos un camino a la salida." } },
      { q: { ko: "클리어 시간이 저장되나요?", en: "Is my clear time saved?", ja: "クリア時間は保存されますか？", zh: "通关时间会保存吗？", fr: "Mon temps est-il sauvegardé ?", es: "¿Se guarda mi tiempo?" }, a: { ko: "최단 클리어 시간은 이 브라우저의 localStorage에만 저장됩니다. 계정도 서버 저장도 없습니다.", en: "Your best clear time is stored only in this browser's localStorage. There is no account or server save.", ja: "最短クリア時間はこのブラウザのlocalStorageにのみ保存されます。アカウントもサーバー保存もありません。", zh: "最短通关时间只保存在本浏览器的localStorage中。没有账号或服务器存档。", fr: "Votre meilleur temps est conservé uniquement dans le localStorage de ce navigateur. Aucun compte ni sauvegarde serveur.", es: "Tu mejor tiempo se guarda solo en el localStorage de este navegador. No hay cuenta ni guardado en servidor." } },
    ],
  },
  "cat-fishing": {
    ...
    faqs: [
      { q: { ko: "난이도가 오르면 무엇이 바뀌나요?", en: "What changes as difficulty rises?", ja: "難易度が上がると何が変わりますか？", zh: "难度提高后会有什么变化？", fr: "Qu'est-ce qui change quand la difficulté monte ?", es: "¿Qué cambia al subir la dificultad?" }, a: { ko: "물고기가 더 빨라지고, 커서가 가까워지면 방향을 틀어 달아납니다. 후반에는 예측 이동으로 미리 앞을 노려야 합니다.", en: "Fish move faster and swerve away when your cursor gets close. Later rounds reward aiming ahead of their path.", ja: "魚が速くなり、カーソルが近づくと向きを変えて逃げます。後半は進路の先を読んで狙う必要があります。", zh: "鱼会变快，光标一靠近就转向逃开。后段要预判它的路线，提前瞄准。", fr: "Les poissons vont plus vite et s'écartent quand le curseur approche. Les manches avancées récompensent l'anticipation de leur trajectoire.", es: "Los peces van más rápido y se apartan cuando el cursor se acerca. Las rondas avanzadas premian apuntar por delante de su trayectoria." } },
      { q: { ko: "기록이 저장되나요?", en: "Is my time recorded?", ja: "タイムは記録されますか？", zh: "用时会被记录吗？", fr: "Mon temps est-il enregistré ?", es: "¿Se registra mi tiempo?" }, a: { ko: "모든 물고기를 잡는 데 걸린 최단 시간이 이 브라우저의 localStorage에만 저장됩니다. 계정도 서버 저장도 없습니다.", en: "Your best time to catch every fish is stored only in this browser's localStorage. There is no account or server save.", ja: "すべての魚を捕まえる最短時間はこのブラウザのlocalStorageにのみ保存されます。アカウントもサーバー保存もありません。", zh: "抓完所有鱼的最短用时只保存在本浏览器的localStorage中。没有账号或服务器存档。", fr: "Votre meilleur temps pour attraper tous les poissons est conservé uniquement dans le localStorage de ce navigateur. Aucun compte ni sauvegarde serveur.", es: "Tu mejor tiempo para atrapar todos los peces se guarda solo en el localStorage de este navegador. No hay cuenta ni guardado en servidor." } },
    ],
  },
  yahtzee: {
