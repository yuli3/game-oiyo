...
export const GAME_GUIDES: Record<string, GameGuide> = {
  ...
  "janggi": {
    ...
    how: { ko: "궁(왕)을 외통수로 몰면 승리합니다. 각 기물은 고유한 이동 규칙을 가지며 궁성 안에서만 움직이는 기물도 있습니다.", en: "Win by checkmating the general. Each piece has unique moves; some stay inside the palace.", ja: "宮(王)を詰めれば勝ち。各駒は固有の動きを持ち、宮城内のみ動く駒もあります。", zh: "将死对方的将（王）即胜。各子有独特走法，部分子只能在九宫内活动。", fr: "Gagnez en matant le général. Chaque pièce a ses mouvements ; certaines restent au palais.", es: "Gana dando jaque mate al general. Cada pieza tiene movimientos únicos; algunas solo en el palacio." },
  ...
  "psychology-wordle": {
    origin: { ko: "심리 워들은 워들 형식에 심리학 용어를 결합한 학습형 단어 게임으로, 놀이로 개념을 익히도록 설계되었습니다.", en: "Psychology Wordle blends the Wordle format with psychology terms — learning concepts through play.", ja: "心理ワードルはワードル形式に心理学用語を組み合わせた学習型単語ゲームです。", zh: "心理学Wordle将Wordle玩法与心理学术语结合，寓学于乐。", fr: "Psychology Wordle mêle le format Wordle à des termes de psychologie — apprendre en jouant.", es: "Psychology Wordle combina el formato Wordle con términos de psicología: aprender jugando." },
    how: { ko: "여섯 번 안에 심리학 관련 단어를 맞히세요. 초록·노랑·회색 힌트는 워들과 동일합니다.", en: "Guess the psychology word in six tries. Green/yellow/gray hints work just like Wordle.", ja: "6回以内に心理学関連の単語を当てます。緑・黄・灰のヒントはワードルと同じです。", zh: "六次机会内猜出心理学词汇。绿黄灰提示与Wordle相同。", fr: "Devinez le mot de psychologie en six essais. Les indices sont ceux du Wordle.", es: "Adivina la palabra de psicología en seis intentos. Las pistas son como en Wordle." },
    faqs: [],
  },
  "snake-game": {
