...
const CHIMP_COPY = {
  ko: {
    ...
    shareText: (level: number) => `침팬지 테스트 레벨 ${level} 도달! game.oiyo.net`,
    copyBtn: '결과 복사',
    copiedBtn: '복사됨',
  },
  en: {
    ...
    shareText: (level: number) => `Chimp Test — reached Level ${level}! game.oiyo.net`,
    copyBtn: 'Copy Result',
    copiedBtn: 'Copied!',
  },
  ja: {
    ...
    shareText: (level: number) => `チンパンジーテスト レベル${level}到達！ game.oiyo.net`,
    copyBtn: '結果をコピー',
    copiedBtn: 'コピー済み',
  },
} as const;
...
const KBD_COPY = {
  ko: {
    ...
    shareText: (accuracy: number, avgMs: number) =>
      `키보드 반응 테스트 — 정확도 ${accuracy}%, 평균 ${avgMs}ms | game.oiyo.net`,
    readyMsg: '준비...',
    goMsg: '시작!',
  },
  en: {
    ...
    copiedBtn: 'Copied!',
    shareText: (accuracy: number, avgMs: number) =>
      `Keyboard Reaction Test — Accuracy ${accuracy}%, Avg ${avgMs}ms | game.oiyo.net`,
    readyMsg: 'Ready...',
    goMsg: 'Go!',
  },
  ja: {
    ...
    copiedBtn: 'コピー済み',
    shareText: (accuracy: number, avgMs: number) =>
      `キーボード反応テスト — 正確率 ${accuracy}%、平均 ${avgMs}ms | game.oiyo.net`,
    readyMsg: '準備中...',
    goMsg: 'スタート！',
  },
} as const;
